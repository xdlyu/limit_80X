...
#        self.mlvj_shape["VV"]      = fit_model;
	...
	if options.closuretest == 0:
        ...
        self.file_Directory = "/afs/cern.ch/work/x/xulyu/private/Summer2017/VVV/ntuple/limit/CMSSW_7_1_5/src/data_YToWWZ_5.2/";
        ...
        if options.pseudodata == 1:
            ...
            self.file_data  = ("mu_PKUTree_2017vvv.root");

        self.file_ggH   = (self.channel+"_PKUTree_%s.root"%(self.signal_sample));
#        self.file_vbfH  = ("WWTree_%s.root"%(self.vbfhiggs_sample));
        ...
        self.file_WJets0_mc = ("mu_PKUTree_WJetsPt180_xww.root");
                
        self.file_VV_mc     = ("mu_PKUTree_VV_xww.root");# WW+WZ
#        self.file_WW_EWK_mc = ("WWTree_WW2jet_phantom.root");# WW_EWK       
        self.file_STop_mc   = ("mu_PKUTree_SingleTop_xww.root");#STop
        self.file_TTbar_mc  = ("mu_PKUTree_TTBARpowheg_xww.root");
